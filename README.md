# Sentor_G | Platinum Kaizo (Casual Playthrough) Rules
This is how I will be playing the Pokémon Platinum Kaizo ROM hack. I just want to play the game, man.
...
| **Duplicate Items** | Any duplicate (non-consumable) held items must be trashed. |
